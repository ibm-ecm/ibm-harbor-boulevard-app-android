...
public class SplashScreenPresenter implements SplashscreenContract.Presenter {
    ...
    /**
     * Create a {@link com.futureworkshops.datacap.common.model.Batch} based on the downloaded
     * configuration.
     */
    @Override
    public void createBatch() {
        mView.showCreatingBatch();

        Batch batch = BatchFactory.createAutocaptureBatch(mContext,
